...
const myCourses = (authUser, filter) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const couseAndSchedule = offeredCourseSections.reduce((acc, obj) => {
        //console.log(obj)
        const course = obj.offeredCourse.course;
        const classSchedules = obj.offeredCourseClassSchedules;
        const existingCourse = acc.find((item) => { var _a; return ((_a = item.couse) === null || _a === void 0 ? void 0 : _a.id) === (course === null || course === void 0 ? void 0 : course.id); });
        if (existingCourse) {

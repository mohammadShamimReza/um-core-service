...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: admin_constants_1.studentSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (admin_constants_1.studentRelationalFields.includes(key)) {
                    return {
                        [admin_constants_1.studentRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }

/*
  ...
  - The values [THRUSDAY] on the enum `WeekDays` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "WeekDays_new" AS ENUM ('SATURDAY', 'SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THRUSDAYStudentSemesterPayment', 'FRIDAY');
ALTER TABLE "offered_course_class_schedule" ALTER COLUMN "dayOfWeek" DROP DEFAULT;
ALTER TABLE "offered_course_class_schedule" ALTER COLUMN "dayOfWeek" TYPE "WeekDays_new" USING ("dayOfWeek"::text::"WeekDays_new");
...
CREATE TABLE "student_semester_payments" (
    ...
    "totalPayedAmount" INTEGER DEFAULT 0,
